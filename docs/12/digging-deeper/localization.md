...
> [!WARNING]
> If you customize the pluralizer's language, you should explicitly define your Eloquent model's [table names](/docs/{{version}}/eloquent/eloquent#table-names).
...
If you are using the [Blade templating engine](/docs/{{version}}/basics/blade), you may use the `{{ }}` echo syntax to display the translation string:
