...
> [!NOTE]
> The results of [Eloquent](/docs/{{version}}/eloquent/eloquent) queries are always returned as `Collection` instances.
...
Typically, you should declare collection macros in the `boot` method of a [service provider](/docs/{{version}}/architecture-concepts/providers).
...
This method is especially useful in [views](/docs/{{version}}/basics/views) when working with a grid system such as [Bootstrap](https://getbootstrap.com/docs/5.3/layout/grid/). For example, imagine you have a collection of [Eloquent](/docs/{{version}}/eloquent/eloquent) models you want to display in a grid:
...
> [!NOTE]
> This method's behavior is modified when using [Eloquent Collections](/docs/{{version}}/eloquent/eloquent-collections#method-contains).
...
> [!NOTE]
> This method's behavior is modified when using [Eloquent Collections](/docs/{{version}}/eloquent/eloquent-collections#method-diff).
...
> [!NOTE]
> This method's behavior is modified when using [Eloquent Collections](/docs/{{version}}/eloquent/eloquent-collections#method-except).
...
> [!NOTE]
> This method's behavior is modified when using [Eloquent Collections](/docs/{{version}}/eloquent/eloquent-collections#method-intersect).
...
> [!NOTE]
> This method's behavior is modified when using [Eloquent Collections](/docs/{{version}}/eloquent/eloquent-collections#method-only).
...
> [!NOTE]
> This method's behavior is modified when interacting with [Eloquent collections](/docs/{{version}}/eloquent/eloquent-collections#method-partition).
...
The `toArray` method converts the collection into a plain PHP `array`. If the collection's values are [Eloquent](/docs/{{version}}/eloquent/eloquent) models, the models will also be converted to arrays:
...
> [!NOTE]
> This method's behavior is modified when using [Eloquent Collections](/docs/{{version}}/eloquent/eloquent-collections#method-unique).
...
To illustrate the usage of this method, imagine an application that submits invoices from the database using a cursor. You could define a [scheduled task](/docs/{{version}}/digging-deeper/scheduling) that runs every 15 minutes and only processes invoices for a maximum of 14 minutes:
